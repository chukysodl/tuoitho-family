...
| TASK-008 | IMPLEMENTED — remote transport, pairing, commands, policy sync, dashboard; awaiting provider deployment and M5 acceptance | task/008-remote-control | implementation `912222cae57c6d2a1578c8e3e3b314d1b3397cfb`; Actions 35806837895 PASS; Release/build/tests/system-check | M5 not run (no Supabase project credentials or deployed endpoint in workspace) |
