...
$parent=Start-Process dotnet -ArgumentList 'run','--project',(Join-Path $root 'src/TuoiTho.Parent'),'--configuration','Release','--no-build' -WorkingDirectory $root -PassThru
...
Write-Output 'M1 START PASS: Parent desktop UI opened.'